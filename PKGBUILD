...
source=(
	...
	"https://github.com/zhmars/cjktty-patches/raw/master/v${major}.x/cjktty-${major}.$(( ${minor} - 1 )).patch"
	"https://github.com/CachyOS/kernel-patches/raw/master/6.8/all/0001-cachyos-base-all.patch")
sha256sums=(
	'28ae9801a730d1a6223f8a2ea3b758ee04bddcb782fa048355086153879d60fc'
...
_pack(){
	pkgdesc="The Linux kernel and modules with CachyOS patches (Compiling with Clang)"
...
_pack-headers(){
	pkgdesc="Headers and scripts for building modules for the Linux kernel (CachyOS cl)"
...
source+=("https://github.com/CachyOS/kernel-patches/raw/master/6.8/sched/0001-bore-cachy.patch")
sha256sums+=(SKIP)
