...
source=(
	...
	"https://github.com/CachyOS/kernel-patches/raw/master/6.7/all/0001-cachyos-base-all.patch")
sha256sums=(
...
source+=("https://github.com/CachyOS/kernel-patches/raw/master/6.7/sched/0001-bore-cachy.patch")
sha256sums+=(SKIP)
