...
_pack(){
	pkgdesc="The Linux kernel and modules with Xanmod patches (Compiling with Clang)"
...
_pack-headers(){
	pkgdesc="Headers and scripts for building modules for the Linux kernel (Xanmod cl)"
